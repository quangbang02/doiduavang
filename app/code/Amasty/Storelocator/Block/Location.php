...
class Location extends Template implements BlockInterface, IdentityInterface
{
    ...
    */
    ...
    public function getListDistrict(){
      $locationCollection = $this->getLocationCollection();//->addAttributeToSelect('city');
      $locationCollection->getSelect()->group('city');
      $city = array();
      foreach ($locationCollection as $location) {
          $city[$location->getCity()] = $location->getCity();
      }
      return $city;
    }
