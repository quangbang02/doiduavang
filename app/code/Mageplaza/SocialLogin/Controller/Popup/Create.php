...
class Create extends CreatePost
{
    ...
    public function __construct(
        ...
        if (!$this->isFrom233()) {
            $customerRepository = ObjectManager::getInstance()->get(CustomerRepository::class);
        } else {
    ...
    protected function isFrom233()
    {
        $version = $this->getMagentoVersion();
        return (version_compare($version, '2.3.3', '>=') ||  version_compare($version, '2.3.3-dev', '>='));
    }
